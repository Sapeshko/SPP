    ...
    class Program
    {
        static async Task Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine($"Тестовый раннер (MaxDegreeOfParallelism: {maxParallelism})");
                ...
                string[] possiblePaths = new[]
                {
                    ...
                    Path.Combine(baseDirectory, "..", "..", "..", "..", "LibraryManagerTests", "bin", "Debug", "net8.0", "LibraryManagerTests.dll"),
                ...
                Console.WriteLine($"Загрузка тестов из: {testAssemblyPath}");
                ...
                Console.WriteLine($"Найдено наборов тестов: {testSuiteTypes.Count}");
                ...
                executor.SetMaxDegreeOfParallelism(maxParallelism);
                ...
                Console.WriteLine($"\n{new string('=', 50)}");
                Console.WriteLine($"Общее время выполнения: {stopwatch.Elapsed:mm\\:ss\\.fff}");
                Console.WriteLine($"Лог сохранен в: {logPath}");
